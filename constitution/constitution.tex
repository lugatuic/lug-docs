...
\AtBeginShipout{\AtBeginShipoutUpperLeft{
		\put(\dimexpr\paperwidth-1cm\relax,-1.5cm){\makebox[0pt][r]{\bf{\framebox{DOCUMENT
						REVIEWED AND APPROVED FOR 2026-2027}}}}
	}}

\title{Basic Rules for the Governance of the Linux User Group for Students at the University
	of Illinois at Chicago}
\author{Linux User Group for Students\\
...
of being a member of the Linux User Group for Students but do not want the responsibility of
...
\section{Expulsion}
A member may be expelled from the Linux User Group for Students for any or all of the
following reasons:
\begin{itemize}
...
Group. It will conduct, on behalf of the Linux User Group for Students, all business it deems
...
Officer positions in the Linux User Group for Students may be created and destroyed at the
...
Linux User Group for Students is to keep things organized, documented, and to help ensure
that the Linux User Group for Students stays on track of its goals as decided by the
...
University tier members of the Linux User Group for Students. These positions are required by
...
\begin{itemize}
	...
	\item Monitor and track progress of goals set for the Linux User Group for Students
...
important process for the Linux User Group for Students.

\section{The Vox}
The Vox consists of all University-Active members of the Linux User Group for Students who
are in good standing and who are not officers in the Linux User Group for Students,
traditional or otherwise, as their position already guarantees them a vote. Each
member of the Linux User Group for Students has the same say in decision making as anyone
...
goings on of the Linux User Group for Students.
...
the Linux User Group for Students.
...
\chapter{USER GROUPS}
User groups are sub-units of the Linux User Group for Students devoted to some business of
interest to one or more members of the Linux User Group for Students. User groups can be
created for any purpose whether it be a general discussion group, a group in
charge of administering some business of the Linux User Group for Students, or anything else
the members desire. Groups exist to have a framework for members of the Linux
User Group to self-organize and participate in and enrich the Linux User Group for Students
community.

No member in good standing may be excluded from a group that that individual
wishes to join.

There are two tiers of Linux User Group for Students: Unofficial and Official.

\section{Unofficial Groups}
Unofficial User Groups may be formed by any member(s) in good standing of the
Linux User Group for Students at any time. Those wishing to create the group should gather
...
Official User Groups are official sub-groups of the Linux User Group for Students. Any
...
\chapter{MEETINGS}
There are two meetings that the Linux User Group for Students holds each year. These meetings
...
\chapter{ADVISOR}
The Linux User Group for Students shall not enlist the assistance of an advisor on any and
all projects. The advisor is to have an overseer role over the organization as
to allow students to maintain autonomy over the Linux User Group for Students. The only time
...
student request alone. The Linux User Group for Students advisor shall not oversee any
